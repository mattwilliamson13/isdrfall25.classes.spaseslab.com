...
* __point__ = attribute refers to the cell center

* __cell__ = attribute refers to an area similar to the pixel

:::

## Take Homes

* Data models translate views of space _into_ analytic tools
