...
2. Import, inspect, and critically evaluate real-world data from multiple sources.

3. Apply `tidyverse` tools to transform and summarize data.

4. Write reusable functions and apply them iteratively to streamline analyses.

5. Reflect on reproducibility, data ethics, and workflow choices as a practicing researcher.

### Submission:
Join [the assignment repository]. In the `docs` folder, you'll find the instructions and questions for the assignment. Submit a single Quarto document (.qmd) with integrated code, outputs, and written responses. Your document should be written as if it were a lab notebook entry: clear enough that another researcher could reproduce your work without asking you questions. Your assignment will be considered complete if the following are true:
